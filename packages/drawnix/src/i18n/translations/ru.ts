...
const ruTranslations: Translations = {
  ...
  'tutorial.description': 'Универсальная доска, включающая ментальные карты, блок-схемы, свободное рисование и многое другое',
